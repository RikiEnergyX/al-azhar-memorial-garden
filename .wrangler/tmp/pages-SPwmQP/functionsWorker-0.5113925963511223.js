...
async function onRequestPost(context) {
  ...
  try {
    ...
    const todayKey = `leads_${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.jsonl`;
    if (env && env.LEADS_KV) {
...
async function onRequest(context) {
  ...
  if (url.pathname.startsWith("/assets/") || url.pathname.startsWith("/images/") || url.pathname.endsWith(".png") || url.pathname.endsWith(".jpg") || url.pathname.endsWith(".svg") || url.pathname.endsWith(".xml") || url.pathname.endsWith(".txt")) {
    return next();
  }
...
// ../.wrangler/tmp/pages-SPwmQP/functionsRoutes-0.31957980667858177.mjs
var routes = [
  {
    routePath: "/api/leads",
    mountPath: "/api",
